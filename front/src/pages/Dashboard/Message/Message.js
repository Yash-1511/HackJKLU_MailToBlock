...
export default function Message() {
  ...
  {
     sent=1;
     tempmail = [...SentEmails].reverse();
  }
  else if(Checkinboxmail >=0)
  {
     tempmail = [...AllMails].reverse()
  }
  else{
     tempmail = [...SpamMails].reverse()
  }
 
  // console.log(tempmail)
  let data = tempmail[slug];
  
  // console.log(data)
  // const encodedString=ncodeRFC5987ValueChars(Filename);
  return (
    <>
      <div className="sm:px-6 px-[-3rem] lg:mx-[-100px]">
        <section className="py-[80px] ">
          <div className="ab">
            <div className="a1s[120px] a2t a2u[#E9ECF8]">
              <div className="a9 a1t a1Y ac[-16px]">
                <div className="a8 lg:a1Q/12 ae">
                  <div>
                    <h2 className="
                    a1k aH a1y
                    sm:a1z
                  ...
                  ">
                      <div className="a9 a1t aa">
                        <div className="a9 aa a2B a1O">
                          ...
                          a2D
                        ">
                            <img src={author} alt="author" className="a8" />
                          </div>
                          <div className="a8">
                            <h4 className="
                            aG
                        ...
                        ">
                            <span className="a2j">
                              <svg width="15" height="15" viewBox="0 0 15 15" className="a1W">
